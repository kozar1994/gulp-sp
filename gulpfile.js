    ...
    return gulp.src([
        ...
        .pipe(plumber({
            errorHandler: notify.onError(function (err) {
                return {
                    title: "Style",
                    message: "Message to the notifier: " + error.message
                }
            })
        }))
...
gulp.task("watch", function () {
    gulp.watch("frontend/style/main.scss", gulp.series("scss"));
    gulp.watch("frontend/js/**/*.js", gulp.series("scripts"));
    gulp.watch("frontend/pug/pages/*.pug", gulp.series("pug"));
});

gulp.task("build", gulp.series("pug", "scss", "scripts"));
